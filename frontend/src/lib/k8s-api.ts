...
export const resourceCategories = [
  ...
  },
  {
    ...
    label: '工作负载',
    icon: 'Apps',
    resources: ['pods', 'deployments', 'statefulsets', 'daemonsets', 'replicasets', 'jobs', 'cronjobs', 'horizontalpodautoscalers', 'poddisruptionbudgets', 'replicationcontrollers'],
  },
  {
    key: 'services',
    label: '服务与网络',
    icon: 'NetworkCheck',
    resources: ['services', 'ingresses', 'endpoints', 'networkpolicies', 'endpointslices'],
  },
  {
    key: 'storage',
    label: '存储',
