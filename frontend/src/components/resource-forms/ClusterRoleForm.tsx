...
import { FormComponentProps, ClusterRoleFormData } from './index'

const defaultData: ClusterRoleFormData = {
  name: '',
  namespace: 'default',
  rules: [],
}

export { defaultData as clusterRoleDefaultData }

export function ClusterRoleForm({ data, onChange, namespaceReadOnly }: FormComponentProps<ClusterRoleFormData>) {
  const d = { ...defaultData, ...data }

  const update = (patch: Partial<ClusterRoleFormData>) => {
    onChange({ ...d, ...patch })
  }
