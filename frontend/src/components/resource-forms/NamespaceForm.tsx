...
import { FormComponentProps, NamespaceFormData } from './index'

const defaultData: NamespaceFormData = {
  name: '',
  namespace: 'default',
  labels: [],
}

export { defaultData as namespaceDefaultData }

export function NamespaceForm({ data, onChange, namespaceReadOnly }: FormComponentProps<NamespaceFormData>) {
  const d = { ...defaultData, ...data }

  const update = (patch: Partial<NamespaceFormData>) => {
    onChange({ ...d, ...patch })
  }
