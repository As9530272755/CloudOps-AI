  ...
  return (
    ...
    >
      ...
      <Box sx={{ flex: 1, display: 'flex', minHeight: 0, overflow: 'hidden' }}>
        {/* Left: panel preview (Grafana places panel centered with actual dimensions) */}
        ...
        {/* Right: options pane */}
        <Box sx={{ width: 420, borderLeft: '1px solid', borderColor: 'divider', overflowY: 'auto', bgcolor: 'background.paper' }}>
